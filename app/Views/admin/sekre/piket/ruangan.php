  ...
  <tbody>
    <?php foreach ($data as $i => $d): ?>
      <tr>
        ...
        <td class="align-middle"><?= esc($d['departemen']) ?></td>
        <td class="align-middle"><?= esc($d['penanggung_jawab']) ?></td>
    ...
    <div class="modal-content">
      <form action="<?= base_url('admin/sekre/piket/ruangan/tambah') ?>" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="tx-bold">Departemen</label>
            <input type="text" name="departemen" class="form-control" required>
          </div>
          <div class="form-group">
            <label class="tx-bold">Penanggung Jawab</label>
